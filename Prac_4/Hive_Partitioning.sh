create these two file in local cloudera
...
1[cloudera@quickstart Prac_4]$ hdfs dfs -mkdir /employee_partition_2023
...
LOAD DATA INPATH '/employee_partition_2023/employee_partition_2023.csv' INTO TABLE employee_partitioned PARTITION (year=2023);
LOAD DATA INPATH '/employee_partition_2024/employee_partition_2024.csv' INTO TABLE employee_partitioned PARTITION (year=2024);
